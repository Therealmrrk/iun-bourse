...
export function acceptanceEmail(app, lang = 'fr') {
  ...
  if (lang === 'fr') {
    return {
      ...
      html: wrap(`
        ...
        <p><strong>Quelle est la prochaine étape ?</strong> Vous recevrez très prochainement un second e-mail vous indiquant la date, l'heure, le lieu (pour l'examen en présentiel) ou le lien de connexion (pour l'examen en ligne) ainsi que les modalités d'évaluation. Cela s'applique aussi bien aux candidats en présentiel qu'en ligne. De plus, vous serez ajouté(e) à un groupe WhatsApp dédié aux candidats. Pensez à vérifier régulièrement votre boîte de réception ainsi que vos courriers indésirables (spams).</p>
        <p>Pour toute question, n'hésitez pas à nous écrire par e-mail à <strong>admissions@iun.tg</strong> (merci de ne pas répondre directement à cet e-mail) ou directement via notre assistance WhatsApp au <strong>${WA}</strong>.</p>
  ...
  return {
    ...
    html: wrap(`
      ...
      <p><strong>What happens next?</strong> You will shortly receive a second email with the date, time, venue (for the in-person exam) or login link (for the online exam), and the exam guidelines. This applies to both in-person and online candidates. Additionally, you will be added to a WhatsApp group dedicated to applicants. Please make sure to monitor your inbox and your spam folder regularly.</p>
      <p>For any questions, feel free to contact us by email at <strong>admissions@iun.tg</strong> (please do not reply directly to this email) or reach out to us directly via WhatsApp at <strong>${WA}</strong>.</p>
