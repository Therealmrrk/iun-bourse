...
export function acceptanceEmail(app, lang = 'fr') {
  ...
  if (lang === 'fr') {
    return {
      ...
      html: wrap(`
        ...
        <p>Pour toute question, n'hésitez pas à nous écrire par e-mail à <strong>info@iun.tg</strong> (merci de ne pas répondre directement à cet e-mail) ou directement via notre assistance WhatsApp au <strong>${WA}</strong>.</p>
  ...
  return {
    ...
    html: wrap(`
      ...
      <p>For any questions, feel free to contact us by email at <strong>info@iun.tg</strong> (please do not reply directly to this email) or reach out to us directly via WhatsApp at <strong>${WA}</strong>.</p>
